        ...
        sections: [
          {
            ...
            table: {
              ...
              rows: [
                ...
                ['운영 형태', '7', '쇼핑몰을 누구에게 얼마나 열지. 한 번 정하면 잘 바꾸지 않는 것'],
                ['화면·노출', '4', '쇼핑몰 화면에 무엇을 보여주고 감출지'],
          ...
          {
            title: '운영 형태와 보안을 가른 기준',
            badge: 'SCOPE',
            body:
              '쇼핑몰을 누구에게 얼마나 열지 정하는 설정은 운영 형태로 모음. 폐쇄몰, 비회원 가격 숨김, 가입 승인은 강도만 다를 뿐 같은 결정이라 흩어 두면 조합을 못 봄.\n' +
              '보안은 계정 자체를 지키는 것만 남김. **추후 ISMS 대응 보안설정 페이지를 따로 만들 계획이라, 그때 이 탭을 통째로 옮길 수 있게 범위를 좁혀 둠.**',
            table: {
              caption: '가른 기준',
              headers: ['탭', '정하는 것', '해당 설정'],
              rows: [
                ['운영 형태', '누구에게 무엇을 열어 줄지', '폐쇄몰, 비회원 상품 가격 정보 숨김, 회원가입 승인 방식, 로그인 유도, 회원정보 작성 알림, 1:1 문의버튼, 탭바 노출'],
