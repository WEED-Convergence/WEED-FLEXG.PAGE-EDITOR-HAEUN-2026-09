        ...
        sections: [
          {
            ...
            table: {
              ...
              rows: [
                ...
                ['화면·노출', '4', '방문자 구분 없이 화면에 무엇을 그리고 감출지'],
                ['상품·장바구니', '4', '상품 상세와 장바구니 동작'],
                ['구매후기', '4', '후기 기능과 작성 정책'],
                ['주문·결제', '9', '주문, 결제, 취소 정책'],
                ['보안', '2', '계정 보호. **추후 ISMS 보안설정 페이지로 분리할 예정이라 미리 갈라 둠**'],
          ...
          },
          {
            ...
            badge: 'SCOPE',
            body:
              '**대상이 회원과 비회원으로 갈리면 운영 형태, 방문자 구분 없이 모두에게 같으면 화면·노출로 가름.**\n' +
              '폐쇄몰, 비회원 가격 숨김, 가입 승인은 강도만 다를 뿐 같은 결정이라 흩어 두면 조합을 못 봄.\n' +
              '보안은 계정 자체를 지키는 것만 남김. 추후 ISMS 대응 보안설정 페이지를 따로 만들 계획이라, 그때 이 탭을 통째로 옮길 수 있게 범위를 좁혀 둠.\n' +
              '1:1 문의버튼은 이 기준에 딱 맞지 않지만, 고객 문의를 어디로 받을지 정하는 운영 창구 설정이라 운영 형태에 둠.',
            table: {
              caption: '가른 기준',
              headers: ['탭', '정하는 것', '해당 설정'],
              rows: [
                ['운영 형태', '회원과 비회원을 어떻게 대할지', '폐쇄몰, 비회원 상품 가격 정보 숨김, 회원가입 승인 방식, 로그인 유도, 카카오 싱크 자동 로그인, 회원정보 작성 알림, 1:1 문의버튼'],
                ['화면·노출', '방문자 구분 없이 화면에 무엇을 그릴지', '복사 방지, 상품고시정보 노출, 이벤트 효과, 탭바 노출'],
                ['보안', '계정 자체를 어떻게 지킬지', '로그인 실패 계정 잠금, 비밀번호 변경 권장 주기'],
              ],
            },
          },
          {
