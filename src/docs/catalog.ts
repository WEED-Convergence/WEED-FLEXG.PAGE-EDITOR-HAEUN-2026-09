    ...
    entries: [
      {
        ...
        common:
          ...
          '설정 34개를 성격별 6개 탭으로 나누고, 전체 탭에서는 34개를 가나다순으로 모두 보여줌\n' +
          ...
          },
          {
            ...
            table: {
              ...
              rows: [
                ...
                ['취소/반품 재고 처리', '미입금 주문건 재고 처리', '부모에 토글이 없어 늘 조작 가능'],
                ['하위가 아닌 것', '구매후기 작성 알림', '이름은 비슷하지만 후기를 쓸 수 있다고 알리는 별개 기능이라 따로 켜고 끔'],
              ],
            },
          },
          {
